// <copyright file="WorkbookNewRequestDialog.axaml.cs" company="WillowTree, LLC">
...
{
    /// <summary>
    /// The workbook new request dialog.
    /// </summary>
    public partial class WorkbookNewRequestDialog : BaseWindow<WorkbookNewRequestViewModel>
    {
        ...
        /// <summary>
        /// Constructs an instance of <see cref="WorkbookNewRequestDialog"/>.
        /// </summary>
        /// <param name="workbookModel">An instance of <see cref="WorkbookModel"/>.</param>
        /// <returns>An instance of <see cref="WorkbookNewRequestDialog"/>.</returns>
        public static WorkbookNewRequestDialog Create(WorkbookModel workbookModel)
        {
            var dialog = new WorkbookNewRequestDialog();
            ...
            dialog.WhenActivated(disposables =>
            {
                ...
                dialog.Bind(
                        dialog.ViewModel,
                        viewModel => viewModel.RequestName,
